...
\ts{TS: incorportate references to deciders writeup if decision is made to put on arxiv. Ask JB if need to cite somewhere the precursor paper to FAR and where.}

\ts{TS: talk about generality}

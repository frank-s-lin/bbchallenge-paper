...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.31\textwidth}
        \centering
        \includegraphics[width=0.5\linewidth]{figures/space-time-diagrams/bb2x4.pdf}
    ...
    \begin{subfigure}[b]{0.32\textwidth}
        \centering
        \includegraphics[width=0.6\linewidth]{figures/space-time-diagrams/bb2x4_20k.png}

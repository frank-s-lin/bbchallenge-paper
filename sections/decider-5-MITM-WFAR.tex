...
\begin{figure}[h]
    ...
    \begin{minipage}[t]{0.23\textwidth}
        ...
        \vspace{0.3em}
        \centering
        \includegraphics[width=1\linewidth]{figures/space-time-diagrams/counter_wfar.png}
    \end{minipage}
    \hfill
    \vrule
    \hfill
            ...
            \begin{minipage}{\textwidth}
                ...
                \[
                    \begin{tikzpicture}[baseline=(base)]
                        ...
                        % Labels
                        \node[below=1.8ex of Wl] (lval) {\scriptsize 2};
                        \node[below=1.8ex of Wr] (rval) {\scriptsize $-1$};

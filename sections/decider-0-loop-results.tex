...
The number of machines decided this decider in \CoqBB (\ie $175{,}373{,}810$, see Table~\ref{tab:paramsLoops}) is a lower bounds of the actual number of 5-state loops. Two examples:

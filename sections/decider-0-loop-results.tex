...
In this sample of $126{,}994{,}099$ nonhalting loops we find approximately 86\% \TCs and 14\% \cyclers which suggests that, in general, \TCs are much more common than \cyclers.

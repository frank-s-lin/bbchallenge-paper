...
\begin{figure}[h!]
    ...
    \caption{60,000-step space-time diagrams of three 5-state machines decided by the Repeated Word List (RepWL) decider, Algorithm~\ref{alg:RepWL}. Left: {\small \url{https://bbchallenge.org/1RB0RD_0LC0LA_0LD1LC_1RA0LE_0RC---}}. Center: {\small \url{https://bbchallenge.org/1RB0LC_1RC1RD_1LD1LE_1LA0RB_---1LA}}. Right: {\small \url{https://bbchallenge.org/1RB---_0RC1RD_0LD1RC_1LE0RA_1RA0LE}}. The RepWL graphs of these machines respectively have 42 and $1{,}231$ and $143{,}181$ nodes, ranging the entire distribution of RepWL node counts for 5-state machines, see Section~\ref{sec:RepWL:results}. RepWL parameters $(l,T)$ for these machines are respectively: $(5,2)$, $(16,2)$, and, $(20,2)$.
...
\subsection{RepWL: results}\label{sec:RepWL:results}
...
Figure~\ref{fig:RepWLhisto} gives the distribution of node counts of the ${6,577}$ RepWL graphs constructed by \CoqBB. The average number of nodes is $1{,}231$ while minimum and maximum are respectively 42 and $143{,}181$. Figure~\ref{fig:repWLThree} gives space-time diagrams for machines  achieving these node counts, \ie 42 (left), ${1,231}$ (center) and $143{,}181$ nodes. These three machines fit in the zoological category of \textit{Bouncers}, see Section~\ref{sec:zoo}.

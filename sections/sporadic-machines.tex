...
\begin{itemize}
    ...
    \item \textbf{Shift Overflow Counters.} This family concerns Skelet's machines 15, 26, 33, 34 and 35; Figure~\ref{fig:sporadic}. They were first analysed by Ligocki \cite{ShawnSOC} then proved in \Coq by Yuen and mei as part of \texttt{busycoq} \cite{busycoq}
\end{itemize}
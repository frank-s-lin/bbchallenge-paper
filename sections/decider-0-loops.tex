...
\begin{lemma} Let $\mathcal{M}$ be a Turing machine.
...
\begin{figure}[h!]
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{tikzpicture}[every node/.style={minimum size=6mm, draw, font=\scriptsize}, scale=1]
            ...
            \node[draw=black, draw opacity=0.7] (A1) at (0.6,1.4) {\stateAx\sone};
            \node[draw=black, draw opacity=0.7] at (1.2,0.8) {\stateCx\szero};
            \node[draw=black, draw opacity=0.7] at (0.6,0.2) {\stateDx\szero};

            \node (B0') at (0,-0.4) {\stateBx\szero};
            \node[draw=black, draw opacity=0.7] (A1') at (0.6,-1.0) {\stateAx\sone};
            \node[draw=black, draw opacity=0.7] at (1.2,-1.6) {\stateCx\szero};
            \node[draw=black, draw opacity=0.7] at (0.6,-2.2) {\stateDx\szero};
    ...
    \begin{minipage}[t]{0.48\textwidth}
        ...
        \begin{tikzpicture}[every node/.style={minimum size=6mm, draw, font=\scriptsize}, scale=1]
            ...
            % P_0
            \node[draw=none] at (-0.2,2.2) {$P_0$};
            \node at (0,2) {B0};
            \node at (0.6,1.4) {A1};
            \node at (1.2,2) {C0};

            % P_0'
            \node[draw=none] at (-0.2,0.9) {$P_0'$};
            \node at (0,0.8) {D0};
            \node at (0.6,0.2) {B0};
            \node at (0, -0.4) {A1};
            \node at (0.6, -1.0) {C0};
            ...
            % P
            \node[draw=none] at (-0.2,-1.6) {$P$};
            \node at (0, -1.8) {D0};
            \node[dashed] at (-0.6, -2.4) {B?};

            % Diagonal arrows (45 degrees)
            \draw[-{Latex[length=1.8mm]}] (-0.8,2.4) -- (-0.1,2.05);
            \draw[-{Latex[length=1.8mm]}] (-0.8,1.0) -- (-0.1,0.85);
            \draw[-{Latex[length=1.8mm]}] (-0.8,-1.3) -- (-0.1,-1.75);

...
Then, the machine does not halt. Although all our deciders fit this framework, its use to justify nonhalting is particularly evident in all deciders but Loops, see Sections~\ref{sec:n-gramCPS}~to~\ref{sec:WFAR}.

...
\begin{table}[h!]
    ...
    \resizebox{\textwidth}{!}{%
        \begin{tabular}{|l|rrr|}
            ...
            8. \texttt{1RB}-reduction, see \textbf{Section~\ref{sec:deciders-overview}}          & 14                              & 0                              & 14            \\ \hline

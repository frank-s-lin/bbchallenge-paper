...
Then, the machine does not halt. NGramCPS and RepWL are simple, yet, really potent direct instances of this idea, see Sections~\ref{sec:n-gramCPS}~and~\ref{sec:RepWL}.

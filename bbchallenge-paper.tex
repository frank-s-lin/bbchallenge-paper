...
\begin{itemize}[label=--]
    ...
    \item A halting machine beating the current $2\uparrow\uparrow\uparrow5$ champion (see Table~\ref{table:landscape} and Appendix~\ref{app:lowerbounds}) could be among these ca.~4,000 holdouts which could require significant analysis or accelerated simulator improvements to be detected.
\end{itemize}

...
\begin{itemize}
    \item $S(6)$: \tm{1RB1RA_0LC1LE_1LD1LC_1LA0LB_1LF1RE_---0RA}; \textbf{Antihydra}.\footnote{\label{note:antihydra}\url{https://wiki.bbchallenge.org/wiki/Antihydra}}
    \item $S(3,3)$: \tm{1RB1RA_0LC1LE_1LD1LC_1LA0LB_1LF1RE_---0RA}; \textbf{Bigfoot}.\footnote{\label{note:bigfoot}\url{https://wiki.bbchallenge.org/wiki/Bigfoot}} Take the following parametrised configuration:
          ...
          The following Collatz-like rules can be proven:
          \[
              \begin{array}{rclcl}

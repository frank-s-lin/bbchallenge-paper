...
More generally, the Busy Beaver game makes us discover \textit{wild} algorithms (\eg Antihydra, or the Sporadic Machines, see Section~\ref{sec:sporadic}), which as computer scientists generates the same childlike wonder as taxonomists may feel discovering new life forms or astronomers new planets.

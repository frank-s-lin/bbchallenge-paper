...
% --- floating picture on the right starting above the list
\begin{wrapfigure}[1]{r}{0.38\textwidth}
    % [14] = number of lines to wrap around (adjust until it covers the list height you want)
    \vspace{-32.5\baselineskip}
    \hspace*{\fill}
    \includegraphics[width=0.7\linewidth]{figures/bbchallenge_logo.png} % replace with your image
\end{wrapfigure}

...
\begin{table}[h]
    ...
    \caption{Landscape of small Busy Beaver values.
        \cellcolor{green!20}Cells highlighted in green (that is, strictly to the left of $S(6)$, $S(3,3)$, and $S(3,4)$) correspond to values for which we provide \Coq proofs. Bright green indicates the new results: $S(5)$ and $S(2,4)$, original to this work.

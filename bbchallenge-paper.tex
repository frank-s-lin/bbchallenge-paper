...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/zoology/1RB1LC_1RC1RB_1RD0LE_1LA1LD_1RZ0LA.png}
        \caption*{Bells}
        {\scriptsize \href{https://bbchallenge.org/1RB1LC_1RC1RB_1RD0LE_1LA1LD_1RZ0LA}{5-state Busy Beaver winner}}
    \end{subfigure}
...
\begin{enumerate}
    ...
    \item \textbf{Bells}; Figure~\ref{fig:zoology}. Bells are loosely defined as Turing machines whose space-time diagrams resemble a succession of bells. The 5-state winner (Figure~\ref{fig:bb5win}) and the 2-state 4-symbol winner (Figure~\ref{fig:bb2x4}) fit this category.
\end{enumerate}

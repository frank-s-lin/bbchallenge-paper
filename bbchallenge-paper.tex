...
Beyond Cryptids, the Busy Beaver game, by means of exhaustive enumeration (see Section~\ref{sec:enum}), makes us discover \textit{wild} algorithms (\eg Antihydra, or the Sporadic Machines, see Section~\ref{sec:sporadic}), which as computer scientists generates the same childlike wonder as biologists may feel discovering new life forms or astronomers new planets, which to us, defies all utilitarian concerns.

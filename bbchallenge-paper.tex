...
\paragraph{So what?} The Busy Beaver problem is a relatively polarizing scientific topic: some love it, some hate it. Common arguments against studying this problem are of a utilitarian nature: what is the \textit{point}, what is the \textit{use}? We leave the floor to Scott Aaronson:
